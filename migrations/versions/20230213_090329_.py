...
Revision ID: ed6da9ffdffe
Revises:
Create Date: 2023-02-13 09:03:29.123197
...
def upgrade():
    ...
    sa.Column('space', sa.String(length=260), nullable=False),
    ...
    sa.Column('spaceId', sa.Integer(), nullable=False),
    sa.Column('imageUrl', sa.String(length=1000), nullable=True),
    sa.Column('createdAt', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updatedAt', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['spaceId'], ['spaces.id'], ),
