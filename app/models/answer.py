...
class Answer(db.Model):
    ...
    questionId= db.Column(db.Integer, db.ForeignKey(add_prefix_for_prod('aurora.questions.id')), nullable=False)
    ...
    question = db.relationship('Question', back_populates='answers', foreign_keys=[questionId])
